        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(email)
                    .addComponent(materia, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(idproveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(materia, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(cerrar)
                        .addGap(18, 18, 18)
                        .addComponent(limpiar)
...
private void limpio(){
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        try{
            con = getConection();
            ps = con.prepareStatement("INSERT INTO proveedor (id_proveedor,nombre, direccion, telefono,email,materia) VALUES(?,?,?,?,?,?)");
            ...
            ps.setString(6, materia.getText());
            limpio();

            //Ejecucion del SQL, para crear y modigicar registros
            int res = ps.executeUpdate();//
            if(res > 0){
                JOptionPane.showMessageDialog(null, "proveedor Guardada exitosamente");
            } else {
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        ...
        try{
            ...
            ps = con.prepareStatement("UPDATE proveedor SET  nombre=?,direccion=?, telefono=?, email=?,materia=?  WHERE id_proveedor=?,");
            ps.setString(1, nombre.getText());
            ps.setString(2, direccion.getText());
            ps.setString(3, telefono.getText());
            ps.setString(4, email.getText());
            ps.setString(5, materia.getText());
            ps.setString(6, idproveedor.getText());
            int res = ps.executeUpdate();
            if(res > 0){
